    ...
    public class cjnep
    {
        public static void FiddlerApplication_BeforeRequest(Session oSession) {
            if (
                ...
                (oSession.url.IndexOf("/lms/web/course/view?") > 0) ||//webtrn 播放页 //http://gzhkzy.cjnep.net/lms/web/course/view?id=98&itemid=42453
        ...
        public static void FiddlerApplication_BeforeResponse(Session oSession) {
            ...
            else if (oSession.url.IndexOf("/lms/web/course/view?") > 0)
            {
